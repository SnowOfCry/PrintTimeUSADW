...
CREATE TABLE IF NOT EXISTS gold.dim_cashier (
    cashier_key INTEGER GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS gold.dim_invoice (
    invoice_key INTEGER GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS gold.dim_payment_method (
    payment_method_key INTEGER GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS gold.dim_payment_type (
    payment_type_key INTEGER GENERATED BY DEFAULT AS IDENTITY,
